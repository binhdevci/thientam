...
{        
    $defaults = array('word' => '', 'img_path' => '', 'img_url' => '', 'img_width' => '10', 'img_height' => '20', 'font_path' => '', 'expiration' => 7200);        
   ...
   if ($word == '')
   {
        $pool = '23456789QWERTYUIPASDFGHJKLZXCVBNM';
    ...
    $text_color        = imagecolorallocate ($im, 20, 5, 209);
