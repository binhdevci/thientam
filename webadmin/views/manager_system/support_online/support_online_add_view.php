...
<table class="form">
	...
	<tr>
		...
		<td><input type="text" name="lb_name_present" id="lb_name_present"class="w350" value="<?=set_value('lb_name_present')?>"></td>
	</tr> 
	<tr>
		<td class="label"><?=lang('yahoo');?></td>
		<td><input type="text" name="lb_yahoo" id="lb_yahoo"class="w350" value="<?=set_value('lb_yahoo')?>"></td>
	</tr> 
	<tr>
		<td class="label"><?=lang('skype');?></td>
		<td><input type="text" name="lb_skype" id="lb_skype"class="w350" value="<?=set_value('lb_skype')?>"></td>
	</tr> 
	<tr>
